...
def create_train_validation_loaders(
    ...
    valid_size = int(validation_ratio * len(dataset))
    sampler_train = torch.utils.data.SubsetRandomSampler(rand_perm[valid_size:])
    sampler_valid = torch.utils.data.SubsetRandomSampler(rand_perm[:valid_size])
